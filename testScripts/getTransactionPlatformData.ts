...
// const txInitiatorId = '18b99dd7-af3e-4c3b-bc3f-a2f1927d6386';
// sdk.apis.tenant.getTransactionPlatformData(txInitiatorId).then((result) => {
//     // console.log('result', JSON.stringify(result, null, 2));
//     // const bidOrder = BidOrder.fromTransaction(sdk, result.transaction);
